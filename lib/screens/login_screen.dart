...
import 'package:weatherapp_starter_project/widgets/login_form_widget.dart';
          ...
          child: Container(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  // section 1
                  Center(child: Image(image: AssetImage('assets/icons/windspeed.png'), height: size.height*0.3,)),
                  Text('Welcome back!', style: TextStyle(fontFamily: 'PoppinsBold', fontSize: 22, ),),
                  Text('Login to know all about weather!', style: TextStyle(fontFamily: 'PoppinsMedium', fontSize: 16, ),),
                  ...
                  return SlideTransition(
                    ...
                    transitionDuration: Duration(milliseconds: 200),
                      ...
                      child: const Text.rich(
                        TextSpan(
                          text: "Don't have an account?",style: TextStyle(fontFamily: 'PoppinsMedium', color: CustomColors.firstGradientColor),
                          children: [
